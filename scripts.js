...
function purple() {
  ...
  document.querySelector(".bar").style.backgroundColor = "#210b38";
}

function blue() {
  localStorage.setItem("bg", "wp.png");
  document.body.style.backgroundImage = 'url("' + "wp.png" + '")';
  document.querySelector(".bar").style.backgroundColor = "#0b2247";
}
...
function showzeonlogon() {
  new WinBox({
    title: "Link a Zeon Account",
    class: ["no-max", "no-min", "no-title", "eclipsemono"],
    x: "center",
    y: "center",
    width: "30%",
    ...
    bottom: 45,
    left: 0,
    mount: document.getElementById("zeonlink").cloneNode(true),
  });
}

function showenvynetlogon() {
  new WinBox({
    title: "Link your EnvyNet Account",
    class: ["no-max", "no-min", "no-title", "eclipsemono"],
    x: "center",
    y: "center",
    width: "30%",
    ...
    bottom: 45,
    left: 0,
    mount: document.getElementById("envynetlink").cloneNode(true),
  });
}
